(() => {
  ...
  const i18n = {
    es: {
      ...
      wayuuBetaBanner: 'Versión en construcción comunitaria. Se muestran términos documentados y el resto permanece temporalmente en español hasta revisión por hablantes Wayuu.', wayuuLanguageTitle: 'Wayuunaiki y construcción comunitaria', wayuuLanguageText1: 'COSTA VIVA incorpora una opción experimental en Wayuunaiki. No se presenta como traducción definitiva. Los términos incluidos proceden de recursos lingüísticos documentados y el resto de la interfaz conserva temporalmente el castellano cuando no existe una equivalencia verificada.', wayuuLanguageText2: 'La versión completa deberá revisarse con hablantes Wayuu. La finalidad no es traducir palabra por palabra, sino construir una interfaz comprensible y culturalmente pertinente junto con la comunidad.', wayuuLanguagePrincipleTitle: 'La lengua también pertenece a la comunidad', wayuuLanguagePrincipleText: 'COSTA VIVA no inventará términos para completar una pantalla. Cuando una traducción no esté verificada se mostrará de forma provisional hasta que pueda ser revisada comunitariamente.',
      wayuuBetaBanner: 'Versão em construção comunitária. São exibidos termos documentados e o restante permanece temporariamente em espanhol até revisão por falantes Wayuu.', wayuuLanguageTitle: 'Wayuunaiki e construção comunitária', wayuuLanguageText1: 'COSTA VIVA incorpora uma opção experimental em Wayuunaiki. Ela não é apresentada como tradução definitiva. Os termos incluídos vêm de recursos linguísticos documentados e o restante da interface permanece temporariamente em espanhol quando não existe equivalência verificada.', wayuuLanguageText2: 'A versão completa deverá ser revisada com falantes Wayuu. A finalidade não é traduzir palavra por palavra, mas construir junto com a comunidade uma interface compreensível e culturalmente pertinente.', wayuuLanguagePrincipleTitle: 'A língua também pertence à comunidade', wayuuLanguagePrincipleText: 'COSTA VIVA não inventará termos para completar uma tela. Quando uma tradução não estiver verificada, será mostrada de forma provisória até que possa ser revisada comunitariamente.',
  ...
  // Capa provisional de Wayuunaiki. El catálogo español funciona como respaldo
  // para no inventar traducciones. Solo se sustituyen términos documentados.
  i18n.guc = {
    ...i18n.es,
    languageAria: 'Anüikii',
    subtitle: 'Cuaderno comunitario de observación costera · Wayuunaiki en revisión',
    notebook: 'Karalouta',
    export: 'Ee’irataa eemüin',
    help: 'Akaalijia',
    measurement: 'Ayaawajaa',
    saveObservation: 'ANAAJAWAA',
    delete: 'Ama’inrüinjiraa',
    sharePackage: 'Ajütaa',
    shareRecords: 'Ajütaa',
    wayuuBetaBanner: 'Versión en construcción comunitaria. Se muestran términos documentados y el resto permanece temporalmente en español hasta revisión por hablantes Wayuu.',
    wayuuLanguageTitle: 'Wayuunaiki y construcción comunitaria',
    wayuuLanguageText1: 'COSTA VIVA incorpora una opción experimental en Wayuunaiki. No se presenta como traducción definitiva. Los términos incluidos proceden de recursos lingüísticos documentados y el resto de la interfaz conserva temporalmente el castellano cuando no existe una equivalencia verificada.',
    wayuuLanguageText2: 'La versión completa deberá revisarse con hablantes Wayuu. La finalidad no es traducir palabra por palabra, sino construir una interfaz comprensible y culturalmente pertinente junto con la comunidad.',
    wayuuLanguagePrincipleTitle: 'La lengua también pertenece a la comunidad',
    wayuuLanguagePrincipleText: 'COSTA VIVA no inventará términos para completar una pantalla. Cuando una traducción no esté verificada se mostrará de forma provisional hasta que pueda ser revisada comunitariamente.'
  }
